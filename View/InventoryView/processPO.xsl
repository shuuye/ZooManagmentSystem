                ...
                <div class="purchase-order">
                    ...
                    <div class="statusBar">
                        ...
                        <div class="actions">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:value-of select="concat('/ZooManagementSystem/Control/InventoryController/cancelOrder.php?POid=', poId)" />
                                            </xsl:attribute>
                            ...
                            <xsl:choose>
                                <xsl:when test="status = 'Draft'">
                                    <a class="sendBtn received" href="{concat('/ZooManagementSystem/Control/InventoryController/approve.php?POid=', poId)}">
                                        Send for approval
                                    </a>
                                </xsl:when>
                                <xsl:when test="status = 'Pending'">
                                    <a class="sendBtn processing" href="{concat('/ZooManagementSystem/Control/InventoryController/receive.php?POid=', poId)}">
                                        Received
                                    </a>
                                </xsl:when>
                                <xsl:when test="status = 'Completed'">
