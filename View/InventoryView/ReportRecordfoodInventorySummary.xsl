    ...
    <xsl:template match="/">
        ...
        <div class="main-content">
            ...
            <table class="reportdisplayingTable">
                ...
                <xsl:for-each select="/root/inventory[itemType = 'Food']">
                    <xsl:sort select="itemType" order="descending" />
                    <xsl:variable name="rowCount" select="count(/root/foodinventory[inventoryId = current()/inventoryId])" />
                    ...
                    <tr>
                        ...
                        <xsl:for-each select="/root/foodinventory[inventoryId = current()/inventoryId]">
                        ...
                        <td rowspan="{$rowCount}">
                            <xsl:value-of select="count(/root/foodinventory[inventoryId = current()/inventoryId])" />
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        <xsl:value-of select="count(/root/foodinventory)"/>
                    </td>
                </tr>
            </table>
