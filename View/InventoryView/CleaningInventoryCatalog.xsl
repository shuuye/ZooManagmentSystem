                    ...
                    <form id="editItemForm" action="../../Control/InventoryController/editInventory.php" method="POST">
                        ...
                        <table class="displayingTable">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="itemName" id="editItemName" /></td>
                            </tr>
                            <tr>
                                <td><label for="editStorageLocation">Storage Location:</label></td>
                                <td><input type="text" name="storageLocation" id="editStorageLocation" /></td>
                            </tr>
                            <tr>
                                <td><label for="editReorderThreshold">Reorder Threshold:</label></td>
                                <td><input type="number" name="reorderThreshold" id="editReorderThreshold" /></td>
                            </tr>
                            <tr>
                                <td colspan="2">
