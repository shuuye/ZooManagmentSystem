    ...
    <xsl:template match="/">
        ...
        <div class="main-content">
            ...
            <table class="reportdisplayingTable">
                ...
                <xsl:for-each select="inventories/inventory[quantity &lt;= 0]">
                ...
                <tr>
                    ...
                    <td>
                        <xsl:value-of select="sum(inventories/inventory[quantity &lt;= 0]/quantity)"/>
                    </td>
                    <td>
                        <xsl:value-of select="count(inventories/inventory[quantity &lt;= 0])"/>
                    </td>
                </tr>
            </table>
