    ...
    <xsl:template match="/">
        ...
        <div class="main-content">
            <header class="report-header">
                <h2>Habitat Decoration Item Brands Inventory Summary Report</h2>
            ...
            <table class="reportdisplayingTable">
                ...
                <xsl:for-each select="/root/inventory[itemType = 'Habitat']">
                    <xsl:sort select="itemType" order="descending" />
                    <xsl:variable name="rowCount" select="count(/root/habitatinventory[inventoryId = current()/inventoryId])" />
                    ...
                    <tr>
                        ...
                        <xsl:for-each select="/root/habitatinventory[inventoryId = current()/inventoryId]">
                        ...
                        <td rowspan="{$rowCount}">
                            <xsl:value-of select="count(/root/habitatinventory[inventoryId = current()/inventoryId])" />
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        <xsl:value-of select="count(/root/habitatinventory)"/>
                    </td>
                </tr>
            </table>
