...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Event Booking Summary Report</title>
                <style>
                    table {
                        width: 100%;
            ...
            <body>
                ...
                <h2>Private Event Summary Report - Booking Summary Report by Event ID</h2>
                <table>
                    <tr>
                        <th>Event ID</th>
